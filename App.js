...
export default function App() {
  ...
  return (
    <NavigationContainer initialRouteName='Root'>
      <Stack.Navigator options={{gestureEnabled:false}} screenOptions={{ headerStyle: { backgroundColor: '#0A1A23', }, headerTintColor: '#FFFFFF' }}>
{true ? <Stack.Screen name="Roo2t" component={Login_lap} options={{ headerShown: false,gestureEnabled:false}} />
        :<Stack.Screen name='Loading_lap' options={{ headerShown: false }} component={Loading_lap} />}
        <Stack.Screen  name="Root" component={Root} options={{ headerShown: false,gestureEnabled:false}} />        
